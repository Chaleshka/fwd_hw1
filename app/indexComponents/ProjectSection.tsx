  ...
  const AutoBackuperImages: Image[] = [
    {
      ...
      src: 'autoBackup1.jpg',
      alt: 'AutoBackuper 1 photo'
    },
    {
      class: 'floating-image h300',
      src: 'autoBackup2.jpg',
      alt: 'AutoBackuper 2 photo'
    }
  ];
...
There I'm creating plugins for game, some desktop software for server side, dome bots for Discord and sometomes developing or updating some features on web-site.`;
  ...
  const HellDoorProjectImages: Image[] = [
    {
      class: 'floating-image h300',
      src: 'HellDoor-project1.jpg',
      alt: 'HellDoor-project 1 photo'
    },
    {
      class: 'floating-image h300',
      src: 'HellDoor-project2.jpg',
      alt: 'HellDoor-project 2 photo'
    },
    {
      class: 'floating-image h300',
      src: 'HellDoor-project3.jpg',
      alt: 'HellDoor-project 3 photo'
    }
  ];
        ...
        <ul>
          <li>
            <div>
              ...
              <SectionContainerWithRightImageImage
                text={AutoBackuperText}
                image={AutoBackuperImages}
                textStyles={{ width: '40%' }}
              />
            </div>
          </li>
          <li>
            <div>
              ...
              <SectionContainerWithRightImageImage
                text={HellDoorProjectText}
                image={HellDoorProjectImages}
                textStyles={{ width: '35%' }}
              />
            </div>
          </li>
