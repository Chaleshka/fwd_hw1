...
<a id="ds-link" href="https://discord.gg/helldoor" target="_blank"><img src="discord-icon.jpg" alt="Discord" style="height: 24px;"></a><br>`;
    ...
    const section3Images : Image[] = [
        { class: 'floating-image h300', src: 'HelldoorProject.jpg', alt: 'helldoor-project' }
    ];
    ...
    return (
        <section id="about">
            <h2>About Me</h2>
            <div>
                <SectionContainerWithRightImageImage text={section1Text} image={section1Images} textStyles={undefined} />
                <br />
                <SectionContainerWithLeftImage text={section2Text} image={section2Images} textStyles={undefined} />
                <br />
                <SectionContainerWithRightImageImage text={section3Text} image={section3Images} textStyles={undefined} />
            </div>
        </section>
    );
  };
